...
== Changelog ==
= 1.7.0 (2022-02-19) =
* Bug fixes. Tested with upt to wordpress 5.9.
* Fixed Server-side cache issue. Loaded fav list using ajax.
* Implemented Client-side logic for cookies.
* Fixed errors appearing on phpcs --standard=WordPress-VIP-Go
