...
<div id="message" class="updated fade"><p><strong><?php _e( 'Options saved.', 'nielsen' ); ?></strong></p></div>
<?php endif; ?>
<div class="wrap">
<h2><?php _e( 'WP Favorite Posts Configuration', 'nielsen' ); ?></h2>
...
<div class="postbox">
	<div title="<?php _e( 'Click to open/close', 'nielsen' ); ?>" class="handlediv">
		<br>
	</div>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<input type="custom_before_image" name="custom_before_image" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['custom_before_image'] ) ); ?>" />
					<br />
					<label for="none">
			...
			<tr>
				<th><?php _e( 'Favorite post per page', 'nielsen' ); ?></th>
				<td>
			...
			<tr>
				<th><?php _e( 'Most favorited posts statistics', 'nielsen' ); ?>*</th>
				<td>
			...
			<tr>
				<th></th>
				<td>
					<input type="submit" name="submit" class="button button-primary" value="<?php _e( 'Update options &raquo;', 'nielsen' ); ?>" />
				</td>
			</tr>
		</table>
...
<div class="postbox">
	...
	<h3 class="hndle"><span><?php _e( 'Label Settings', 'nielsen' ); ?></span></h3>
	<div class="inside" style="display: block;">


		<table class="form-table">
			<tr>
				<th><?php _e( 'Text for add link', 'nielsen' ); ?></th>
				<td><input type="text" name="add_favorite" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['add_favorite'] ) ); ?>" /></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for added', 'nielsen' ); ?></th>
				<td>
			...
			<tr>
				<th><?php _e( 'Text for remove link', 'nielsen' ); ?></th><td><input type="text" name="remove_favorite" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['remove_favorite'] ) ); ?>" /></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for removed', 'nielsen' ); ?></th>
				<td>
			...
			<tr>
				<th><?php _e( 'Text for clear link', 'nielsen' ); ?></th><td><input type="text" name="clear" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['clear'] ) ); ?>" /></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for cleared', 'nielsen' ); ?></th><td><input type="text" name="cleared" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['cleared'] ) ); ?>" /></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for favorites are empty', 'nielsen' ); ?></th><td><input type="text" name="favorites_empty" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['favorites_empty'] ) ); ?>" /></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for [remove] link', 'nielsen' ); ?></th><td><input type="text" name="rem" value="<?php echo wp_kses_post( stripslashes( $nlsn_options['rem'] ) ); ?>" /></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for favorites saved to cookies', 'nielsen' ); ?></th><td><textarea name="cookie_warning" rows="3" cols="35"><?php echo wp_kses_post( stripslashes( $nlsn_options['cookie_warning'] ) ); ?></textarea></td>
			</tr>
			<tr>
				<th><?php _e( 'Text for "only registered users can favorite" error message', 'nielsen' ); ?></th><td><textarea name="text_only_registered" rows="2" cols="35"><?php echo wp_kses_post( stripslashes( $nlsn_options['text_only_registered'] ) ); ?></textarea></td>
			</tr>
...
<div class="postbox">
	<div title="<?php _e( 'Click to open/close', 'nielsen' ); ?>" class="handlediv"><br></div>
	<h3 class="hndle"><span><?php _e( 'Advanced Settings', 'nielsen' ); ?></span></h3>
	<div class="inside" style="display: block;">
		<table class="form-table">
			<tr>
				<td>
...
<div class="postbox">
	<div title="<?php _e( 'Click to open/close', 'nielsen' ); ?>" class="handlediv"><br></div>
	<h3 class="hndle"><span><?php _e( 'Help', 'nielsen' ); ?></span></h3>
	<div class="inside" style="display: block;">
